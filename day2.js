...
let instructions = fs.readFileSync('day2_input.txt', 'utf-8')
    .trimRight()
    .split('\n')
    .map(function (el) {
        return el
...
for (let dimensions of instructions) {
    wrapping_paper += surface_area.apply(this, dimensions);
    wrapping_paper += smallest_side.apply(this, dimensions);
}
